...
type GenesisState struct {
	...
	FilmList      []Film     `protobuf:"bytes,4,rep,name=filmList,proto3" json:"filmList"`
...
func (m *GenesisState) GetFilmList() []Film {
	if m != nil {
		return m.FilmList
	}
	return nil
...
func (m *GenesisState) GetFilmCount() uint64 {
	if m != nil {
		return m.FilmCount
	}
	return 0
...
var fileDescriptor_fd7bed4810454f6c = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.FilmCount != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.FilmCount))
		i--
		dAtA[i] = 0x28
	}
	if len(m.FilmList) > 0 {
		for iNdEx := len(m.FilmList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FilmList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.FilmList) > 0 {
		for _, e := range m.FilmList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	if m.FilmCount != 0 {
		n += 1 + sovGenesis(uint64(m.FilmCount))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilmList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FilmList = append(m.FilmList, Film{})
			if err := m.FilmList[len(m.FilmList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilmCount", wireType)
			}
			m.FilmCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FilmCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
